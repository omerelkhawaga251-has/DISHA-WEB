...
export const DISHA_INFO = {
  ...
  socials: {
    ...
    discord: {
      handle: 'Disha Discord Server',
      link: 'https://discord.gg/uqJ6DuZ4GH',
    },
  },
  stats: [
...
// ──────────────────────────────────────────────────────────────
// 2. POST DESIGNS (18 تصميم بوستر إعلاني فريد 100% من مجلد Post Designs)
// ──────────────────────────────────────────────────────────────
export const POST_DESIGNS: ProjectItem[] = [
  {
    ...
    description: 'تصميم بوستر إعلاني مبتكر يدمج تمثال أبو الهول بالنظارات الرقمية مع تفاصيل عرض n8n السنوي 1199 جنيه والدفع بالجنيه المصري وسيرفرات مستقرة.',
  ...
  {
    id: 'p3',
    title: 'بوستر إعلاني تسويقي - حملة أتمتة n8n (شخصية الباندا المحارب)',
    category: 'post-design',
    categoryLabel: 'Post Design // تسويقي',
  ...
  {
    id: 'p7',
    title: 'بوستر إعلاني لحملة خصم 40% - مجسم 3D الزجاجي الأخضر',
    category: 'post-design',
    categoryLabel: 'Post Design // 3D Visual',
    image: '/post-designs/post_7.png',
    description: 'تصميم بوستر إعلاني تسويقي متكامل لحملة تخفيضات الباقة السنوية لمنصة رؤياي وأتمتة n8n مع تجسيد رقم 40% الزجاجي المتوهج ثلاثي الأبعاد.',
    software: ['Photoshop', '3D Rendering'],
    isCreativityShowcase: true,
  },
  {
    id: 'p8',
  ...
  {
    id: 'p9',
    title: 'بوستر إعلاني سوشيال ميديا - حملة عروض الاستضافة الصيفية',
    category: 'post-design',
    categoryLabel: 'Post Design // Social Media',
    image: '/post-designs/post_9.jpeg',
    description: 'تصميم إعلاني سوشيال ميديا متقن يركز على وضوح العرض والألوان الجذابة لزيادة معدل التحويل والمبيعات.',
    software: ['Photoshop'],
  },
  {
    id: 'p10',
    title: 'بوستر تسويقي - حلول السيرفرات السحابية والأداء الفائق',
    category: 'post-design',
    categoryLabel: 'Post Design // Cloud Tech',
    image: '/post-designs/post_10.jpeg',
    description: 'تصميم بوستر تقني موجه لأصحاب المواقع والتطبيقات لإبراز استقرار الخوادم وسرعة الاستجابة.',
    software: ['Photoshop'],
  },
  {
    id: 'p11',
    ...
    category: 'post-design',
    categoryLabel: 'Post Design // Viral Visual',
    image: '/post-designs/post_11.jpeg',
  ...
  {
    id: 'p12',
    title: 'بوستر إعلاني مبتكر - احجزني عشان غيرك عايزني (ميكروباص العمرانية)',
    category: 'post-design',
    categoryLabel: 'Post Design // Creative Ads',
    image: '/post-designs/post_12.jpeg',
  ...
  {
    id: 'p13',
    title: 'تصميم ستوري وبوستر موبايل - بديل هوستنجر الأقوى Rooyai',
    category: 'post-design',
    categoryLabel: 'Post Design // Mobile Story',
    image: '/post-designs/post_13.jpeg',
  ...
  },
  {
    ...
    category: 'post-design',
    categoryLabel: 'Post Design // Social Media',
    image: '/post-designs/post_14.jpeg',
  ...
  },
  {
    ...
    image: '/post-designs/post_15.jpeg',
  ...
  },
  {
    ...
    category: 'post-design',
    categoryLabel: 'Post Design // AI Tech',
    image: '/post-designs/post_16.jpeg',
    description: 'تصميم عصري مع تأثيرات إضاءة متوهجة تبرز سهولة استخدام نماذج AI عبر واجهة برمجية موحدة.',
    software: ['Photoshop'],
  },
  {
    id: 'p17',
    title: 'بوستر إعلاني لحملة n8n Hosting السنوية (Annual Offer 1199 EGP)',
    category: 'post-design',
    categoryLabel: 'Post Design // Annual Offer',
    image: '/post-designs/post_17.jpeg',
  ...
  },
  {
    ...
    image: '/post-designs/post_18.jpeg',
...
// ──────────────────────────────────────────────────────────────
// 3. YOUTUBE THUMBNAILS (15 صورة مصغرة فريدة 100% من مجلد YouTube Thumbnails)
// ──────────────────────────────────────────────────────────────
export const YOUTUBE_THUMBNAILS: ProjectItem[] = [
  ...
  {
    id: 't4',
    title: 'تصميم ثمبنيل يوتيوب - إطلاق ROOYALLM API (وداعاً OpenAI)',
    category: 'thumbnail',
    categoryLabel: 'YouTube Thumbnail',
  ...
  {
    id: 't6',
    title: 'تصميم ثمبنيل يوتيوب - دمج Binance مع n8n للأتمتة المالية',
    category: 'thumbnail',
    categoryLabel: 'YouTube Thumbnail',
  ...
  },
  {
    ...
    category: 'thumbnail',
    categoryLabel: 'YouTube Thumbnail',
    image: '/yt-thumbnails/yt_9.png',
    description: 'تصميم ثمبنيل تعليمي عالي التباين مصمم لزيادة نسبة النقر إلى الظهور CTR بين الفيديوهات المقترحة.',
    software: ['Photoshop'],
  },
  {
    id: 't10',
    title: 'تصميم ثمبنيل يوتيوب رسمي - دليل إتقان المونتاج وسرد القصة',
    category: 'thumbnail',
    categoryLabel: 'YouTube Thumbnail',
    image: '/yt-thumbnails/yt_10.jpg',
    description: 'تصميم صورة مصغرة احترافية تبرز موضوع الفيديو بجودة عالية 1280x720 محسنة لخوارزميات يوتيوب.',
    software: ['Photoshop'],
  },
  {
    id: 't11',
    title: 'تصميم ثمبنيل يوتيوب رسمي - مهارات تعديل الألوان السينمائية',
    category: 'thumbnail',
    categoryLabel: 'YouTube Thumbnail',
    image: '/yt-thumbnails/yt_11.jpg',
    description: 'تصميم ثمبنيل يوتيوب مع تدرجات لونية وإضاءة مدروسة لجذب نقرات المشاهدين في الصفحة الرئيسية.',
    software: ['Photoshop'],
  },
  {
    id: 't12',
    ...
    category: 'thumbnail',
    categoryLabel: 'YouTube Thumbnail',
    image: '/yt-thumbnails/yt_12.jpeg',
  ...
  },
  {
    ...
    category: 'thumbnail',
    categoryLabel: 'YouTube Thumbnail',
    image: '/yt-thumbnails/yt_13.jpeg',
  ...
  },
  {
    ...
    category: 'thumbnail',
    categoryLabel: 'YouTube Thumbnail',
    image: '/yt-thumbnails/yt_14.jpeg',
    description: 'ثمبنيل يوتيوب تقني مع تباين لوني قوي ورسومات توضيحية تجذب المهتمين بالتقنية والتداول.',
    software: ['Photoshop'],
  },
  {
    id: 't15',
    title: 'تصميم ثمبنيل يوتيوب - أسرار صناعة المحتوى الفيروسي والانتشار',
    category: 'thumbnail',
    categoryLabel: 'YouTube Thumbnail',
    image: '/yt-thumbnails/yt_15.jpeg',
